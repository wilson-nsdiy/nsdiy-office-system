...
// was not loaded in eager-loading.
func (e RoleEdges) RolePermsOrErr() ([]*RolePerm, error) {
	if e.loadedTypes[1] {
...
func (*Role) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case role.FieldIsActive, role.FieldIsDefault, role.FieldIsBuiltin:
			values[i] = new(sql.NullBool)
		case role.FieldID:
			values[i] = new(sql.NullInt64)
		case role.FieldName, role.FieldCode, role.FieldDescription, role.FieldRoleType:
...
// QueryRolePerms queries the "role_perms" edge of the Role entity.
func (_m *Role) QueryRolePerms() *RolePermQuery {
	return NewRoleClient(_m.config).QueryRolePerms(_m)
}
