...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			articleversion.Table:           articleversion.ValidColumn,
			mediaaccount.Table:             mediaaccount.ValidColumn,
			mediaaccountfanssnapshot.Table: mediaaccountfanssnapshot.ValidColumn,
			mediacontent.Table:             mediacontent.ValidColumn,
			mediacontentversion.Table:      mediacontentversion.ValidColumn,
			news.Table:                     news.ValidColumn,
			newsgroup.Table:                newsgroup.ValidColumn,
			operationlog.Table:             operationlog.ValidColumn,
			permission.Table:               permission.ValidColumn,
			project.Table:                  project.ValidColumn,
			projectmember.Table:            projectmember.ValidColumn,
			role.Table:                     role.ValidColumn,
			roleperm.Table:                 roleperm.ValidColumn,
